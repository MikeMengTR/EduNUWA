...
class TextEncoder(nn.Module):
    def __init__(
        ...
        self.mrte = MRTE(hidden_size=gin_channels)
...
class SynthesizerTrnV3(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.use_sdp = use_sdp
        self.enc_p = TextEncoder(
            inter_channels, hidden_channels, filter_channels, n_heads, n_layers, kernel_size, p_dropout, gin_channels=gin_channels
        )
