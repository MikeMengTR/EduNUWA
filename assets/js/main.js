...
(function () {
  ...
  const I18N = {
    zh: {
      ...
      "what.c3.t": "反馈自进化",
      "what.c3.p": "学生评价通过「文本梯度」回流：众评风格标签按确定性公式累积置信度，让 Skill 的风格描述越用越贴切——学生按风格找老师时，匹配也就越来越准。",
    ...
    en: {
      ...
      "what.c3.p": "Student feedback flows back as a textual gradient: crowd style tags accumulate confidence via deterministic formulas, keeping each skill's style description accurate — so style-based teacher matching gets sharper over time.",
